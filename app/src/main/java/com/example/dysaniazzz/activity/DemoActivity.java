...
public class DemoActivity extends BaseActivity {
    ...
    @OnClick(R.id.btn_demo_unbindservice)
    public void onUnbindClick() {
        unbindService(mConnection);                             //解绑服务（只能解绑一次）
    }

    @OnClick(R.id.btn_demo_stoptask)
